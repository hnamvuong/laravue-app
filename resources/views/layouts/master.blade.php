...
<head>
    ...
    <title>Laravue App | Starter</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 position-fixed">
            <!-- Brand Logo -->
            <router-link to="/profile" class="brand-link">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2020 <a href="https://www.facebook.com/vuong.trinhquoc.hn/"
                    target="_blank">VuongTQ</a>.</strong> All
            rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
